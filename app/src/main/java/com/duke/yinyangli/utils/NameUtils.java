...
public class NameUtils {
    ...
    private static String[] firstNameArray = { "赵", "钱", "孙", "李", "周", "吴", "郑", "王", "冯", "陈",
            ...
            "黄", "和", "穆", "萧", "尹", "姚", "邵", "湛", "汪", "祁", "毛",
            "狄", "米", "贝", "明", "臧", "计", "伏", "成", "戴", "谈", "宋",
            "茅", "庞", "熊", "纪", "舒", "屈", "项", "祝", "董", "梁", "杜", "阮",
            "蓝", "闽", "席", "季", "麻", "强", "贾", "路", "娄", "江", "童",
    ...
    private static String[] endNameArray = { "伟", "秀英", "娜", "敏", "静", "丽", "强", "磊", "军",
            "洋", "勇", "艳", "杰", "娟", "涛", "明", "超", "明" , "霞", "琪", "祺", "澄",
            "平", "刚", "桂英", "芳", "方", "锷", "旭", "煜", "融", "秀兰", "登月", "登云",
            "天凯", "振辉", "凌霄", "天明", "玄明", "泽凯", "泽楷", "泽锋", "凌云", "辰龙",
            "嘉懿", "煜城", "懿轩", "烨伟", "苑博", "伟泽", "浩辰", "浩然", "皓然", "伟泽",
            "熠彤", "鸿煊", "博涛", "烨霖", "烨华", "煜祺", "智宸", "正豪", "昊然", "明杰",
            "立诚", "立轩", "立辉", "峻熙", "弘文", "熠彤", "鸿煊", "烨霖", "哲瀚", "鑫鹏",
            "致远", "俊驰", "雨泽", "烨磊", "晟睿", "天佑", "文昊", "修洁", "黎昕", "远航",
            "旭尧", "鸿涛", "伟祺", "荣轩", "越泽", "浩宇", "瑾瑜", "皓轩", "擎苍", "擎宇",
            "志泽", "睿渊", "楷瑞", "子轩", "弘文", "鑫磊", "修杰", "俊杰", "伟诚", "建辉",
            "晋鹏", "天磊", "绍辉", "泽洋", "明轩", "健柏", "鹏煊", "昊强", "伟宸", "登风",
            "博超", "君浩", "子骞", "明辉", "鹏涛", "炎彬", "鹤轩", "越彬", "风华", "星云",
            ...
            "锐达", "睿慈", "绍祺", "圣杰", "思源", "斯年", "泰宁", "星楷", "同巍", "念慈",
            "奕伟", "祺温", "文虹", "向笛", "心远", "欣德", "新翰", "兴言", "星阑", "修为",
            "旭尧", "炫明", "学真", "雪风", "雅昶", "阳曦", "烨熠", "英韶", "永贞", "咏德",
            "宇寰", "雨泽", "玉韵", "越彬", "子瑜", "哲彦", "振海", "正志", "子晋", "自怡",
            "德赫", "君平", "夏菡", "若烟", "半梦", "雅绿", "冰蓝", "灵槐", "梓潼", "梓涵",
            "平安", "书翠", "翠风", "代云", "子玉", "听寒", "梦柏", "醉易", "访旋", "佳璇",
            "健聪", "凌萱", "访卉", "怀亦", "紫霄", "靖柏", "书雪", "乐枫", "念薇", "稼轩",
            "靖康", "敏聪", "恨山", "夏至", "振宏", "振东", "代真", "子涵", "紫嫣", "子路",
            "迎春", "雁玉", "探春", "紫山", "千琴", "恨天", "盼山", "怀蝶", "冰兰", "红烛",
            "金瀚", "从南", "白易", "问筠", "如霜", "寒雁", "怜云", "寻文", "谷雪", "谷雨",
            "乐萱", "涵菡", "海莲", "傲蕾", "青槐", "冬儿", "易梦", "惜雪", "宛海", "紫烟",
            "夏青", "碧柔", "妃萱", "潇潇", "存义", "乘风", "云阙", "凤仙", "彦璋", "子凡",
            "林轩", "玄礼", "昭义", "存忠", "亚楠", "华年", "志杰", "玄明", "玄真", "容若",
            "存书", "云龙", "琦刚"};

    private static String[] departments = {"青城派", "茅山道士", "少林寺", "武当派", "峨眉派", "龙虎山"
            , "衡山", "恒山", "华山", "嵩山", "泰山", "蜀山", "唐门", "昆仑派", "崆峒派", "逍遥派", "神农帮"
            , "丐帮", "古墓派", "全真教", "日月神教", "明教", "大雪山", "红花会", "五毒教", "桃花岛", "光明神教"
            , "原理神教", "神龙教", "侠客教", "黑白学宫", "两仪教", "摩尼教", "八卦门", "万毒门", "青云山"
            , "合欢派", "焚香谷", "天音寺", "金刚门", "鬼王宗", "稷下学宫", "天下会", "蓬莱仙岛", "上清宫"
            , "灵宝宫", "灵隐寺", "洪门", "青帮", "形意门", "八极门", "正一道", "灵鹫宫", "侠客岛", "星宿派"};


    public static String getRandomName() {
        Random random = new Random();
        int x = random.nextInt(10000000);
        String depart = departments[x % departments.length];
        x = random.nextInt(10000000);
        String firstName = firstNameArray[x % firstNameArray.length];
        x = random.nextInt(10000000);
        String endName = endNameArray[x % endNameArray.length];
        return depart + firstName + endName;
    }
}
